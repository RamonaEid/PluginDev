...
function bomanite_init() {
    ...
    wp_register_script('bomanite-full', plugins_url('js/bomanite_full.js', __FILE__), array('jquery'), '030616', true );
...
function bomanite_enqueue_scripts() {
    ...
    wp_enqueue_script( 'bomanite-full', plugins_url('js/bomanite_full.js', __FILE__), array('jquery'), '030616', true );
