...
function bomanite_init() {
    ...
    wp_register_script('bomanite-full', plugins_url('js/bomanite_full.js', __FILE__), array('jquery'), '031516', true );
...
function bomanite_enqueue_scripts() {
    ...
    wp_enqueue_style( 'bomanite-accordion-style', plugins_url('css/bomanite_accordion.css', __FILE__), array(), '1.0.2' );
    ...
    wp_enqueue_script( 'bomanite-full', plugins_url('js/bomanite_full.js', __FILE__), array('jquery'), '031516', true );
